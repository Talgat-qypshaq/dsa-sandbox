public class BinaryTree<T> extends BinaryTreeBasis<T>
{
  ...
  public void setRootItem(T newItem)
  {
    ...
    else root = new TreeNode<T>(newItem, null, null);
  }
  ...
  {
    if(isEmpty())
      throw new TreeException("Attach Left Subtree Exception: Empty Tree");
    else
  ...
  {
    if(isEmpty())
      throw new TreeException("Attach Right Subtree Exception: Empty Tree");
    else
  ...
  {
    if(isEmpty())
      throw new TreeException("Detach Left Subtree Exception: Empty tree");
    else
    {
  ...
  {
    if(isEmpty())
      throw new TreeException("Detach Right Subtree Exception: Empty tree");
    else
    {
